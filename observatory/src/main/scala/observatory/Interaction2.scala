...
object Interaction2 extends Interaction2Interface {
  private val temperatureToColor : List[(Temperature, Color)] = List((60, Color(255, 255, 255)), (32, Color(255, 0, 0)),
    (12, Color(255, 255, 0)), (0, Color(0, 255, 255)), (-15, Color(0, 0, 255)), (-27, Color(255, 0, 255)),
    (-50, Color(33, 0, 107)), (-60, Color(0, 0, 0)))

  private val deviationsToColor : List[(Temperature, Color)]= List((7, Color(0, 0, 0)), (4, Color(255, 0, 0)),
  ...
  def availableLayers: Seq[Layer] = {
    List(
      Layer(LayerName.Temperatures, temperatureToColor, Range(1975, 2015)),
      Layer(LayerName.Deviations, deviationsToColor, Range(1990, 2015)))
  }
